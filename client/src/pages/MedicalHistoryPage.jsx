  ...
  const handleRemoveCondition = async (conditionId) => {
    ...
    try {
      const response = await fetch(
        `/api/users/${userId}/conditions/${conditionId}`,
        {
          method: "DELETE",
        },
      );
      ...
      <nav className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <button
            ...
            className="text-slate-600 hover:text-blue-600 flex items-center gap-2 transition-all"
          >
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        <header className="mb-10">
          ...
          <p className="text-slate-500 mt-2">
            Manage your conditions and reports to personalize your meal plans.
          </p>
        </header>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="grid gap-4">
                    {conditions.map((condition) => (
                      <div
                        ...
                        className="group border border-slate-100 rounded-xl p-5 hover:border-blue-300 hover:bg-blue-50/30 transition-all"
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <button
                            onClick={() =>
                              handleRemoveCondition(condition.condition_id)
                            }
          ...
          <div className="space-y-8">
            ...
            <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
              ...
              <div
                className={`relative group border-2 border-dashed rounded-xl p-6 text-center transition-all ${
                  uploadingFile
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-medium text-slate-700">
                    {uploadingFile ? "Uploading..." : "Click to upload report"}
                  </p>
                ...
                {labReports.map((report, idx) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="ml-3 text-xs font-bold text-blue-600 hover:text-blue-800 underline"
                    >
                      View
                    </button>
                  </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-xl shadow-blue-200">
              ...
              <p className="text-blue-100 text-sm mb-4">
                We use your {conditions.length} conditions and{" "}
                {labReports.length} reports to curate a diet that's right for
                you.
              </p>
              <button
                onClick={() => navigate("/recipes")}
