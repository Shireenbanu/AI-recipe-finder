  ...
  const fetchConditions = async () => {
    try {
      ...
      if (data.success && userConditions) {
        ...
        console.log(
          "Filtered Conditions (Available to add):",
  ...
  const fetchConditionforUser = async () => {
    try {
      const response = await authFetch(
        `/api/users/${userId}/nutritional-needs`,
      );
      const data = await response.json();
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-10 text-center">
          ...
          <p className="text-lg text-slate-600">
            Select conditions to tailor your AI-generated meal plans.
          </p>
        </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        {Object.entries(condition.recommended_nutrients).map(
                          ([nutrient, level]) => (
                            <span
                              key={nutrient}
